          ...
          <div className="relative z-10 text-center py-16 px-8 md:py-20 md:px-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="btn-gradient flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold shadow-xl shadow-indigo-500/25 text-sm"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl glass border border-white/10 text-gray-200 hover:text-white hover:border-indigo-400/30 transition-all duration-300 font-semibold text-sm hover:shadow-lg hover:shadow-indigo-500/10"
              >
